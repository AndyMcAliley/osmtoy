...
# my address
lon = -105.04285735612923
lat = 39.8388427570848
...
ways_filename = '7820_Raleigh.ways'
...
bought_way_ids = [16978565]
# bought_way_ids = [result.ways[0].id]
...
# pane.add_periodic_callback(end_turn, period=5000)

# layout = row(p,table_name)
# curdoc().add_root(layout)
# curdoc().add_periodic_callback(end_turn, 5000)
# output_notebook()
# show(p)
