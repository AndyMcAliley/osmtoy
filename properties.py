...
GAMEPLAY
    Birds: build nests
    Buy properties not roads
    Tune building cost and income
    Add building maintenance
        Cost per turn, OR
        # turns before road needs repair
    Add different resources
        Choose which resource a given building produces
        Food (in radius around nest)
            Hunt
            Forage
            Limited supply/regen
        Water
        Birds
        Energy (rest, food, water)
        Twigs/nest building materials
        - Twigs
        - Leaves
        - Grass
        - Feathers
        ...
        - Fabric
        - Hair
        Nest properties/upgrades
        - Structure
        - Camoflauge
        - Magpie-like trinkets
        ...
        - Longevity/upkeep
    Add dangers
        Predators of grown birds
        Predators of eggs
        Predators of baby birds
        Human influence: destroy nest
        Wind storms
        Famine (freeze?)
    Add things to buy and tech tree/upgrades
        Better nests
        Increase hunting range
        Effective hunting
